...
import deviceModelsBackground from 'assets/imgs/device-models-background.jpg';
import deviceModelsBackgroundLarge from 'assets/imgs/device-models-background-large.jpg';
import deviceModelsBackgroundPlaceholder from 'assets/imgs/device-models-background-placeholder.jpg';
import deviceModels from 'assets/imgs/device-models.jpg';
import deviceModelsLarge from 'assets/imgs/device-models-large.jpg';
import deviceModelsPlaceholder from 'assets/imgs/device-models-placeholder.jpg';
import deviceModelsBranding from 'assets/imgs/device-models-branding.png';
import deviceModelsBrandingLarge from 'assets/imgs/device-models-branding-large.png';
        ...
        <ProjectSection>
          <ProjectSectionContent>
            <ProjectTextRow center centerMobile noMargin>
              ...
              <ProjectSectionText>
                Within 24 hours of hard work, the site was completed. We were the only team which managed to apply our translation algorithm and connect it to an AWS server, and win first place and eternal glory.
              </ProjectSectionText>
              <Button
                secondary
                iconHoverShift
