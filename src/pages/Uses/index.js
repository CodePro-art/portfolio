          ...
          <ProjectTextRow width="m">
            ...
            <ProjectSectionText>
              <ul>
                ...
                <li>
                  In the realm of AI development, I utilize{' '}
                  <Link href="https://www.tensorflow.org">TensorFlow</Link> for building
                  and training machine learning models. Its extensive library supports
                  various tasks from image recognition to natural language processing.
                </li>
                <li>
                  I also work with{' '}
                  <Link href="https://pytorch.org">PyTorch</Link>, known for its
                  dynamic computation graph, making it ideal for research and rapid
                  prototyping of neural networks.
                </li>
                <li>
                  For experimenting with and deploying models, I leverage{' '}
                  <Link href="https://huggingface.co">Hugging Face</Link>'s extensive collection of pre-trained models and a user-friendly API
                  for NLP tasks.
                </li>
                <li>
                  I use{' '}
                  <Link href="https://www.kaggle.com">Kaggle</Link> for accessing
                  datasets and participating in competitions. It's a fantastic platform
                  for honing my skills and learning from other data scientists.
                </li>
                <li>
                  Finally, I utilize{' '}
                  <Link href="https://www.fast.ai">Fastai</Link> to streamline deep
                  learning training processes, allowing for faster experimentation and
                  learning.
                </li>
              </ul>
            </ProjectSectionText>
